    ...
    <section className="py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          <div className="bg-gradient-to-br from-white/10 via-white/5 to-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-xl">
                  <Youtube className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">Join Our Growing Community</h3>
                <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
                  Subscribe to our YouTube channel for powerful messages, glorious songs, and spiritual insights. 
                  Experience God's transformative power through inspiring worship and biblical teaching.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-3 rounded-xl font-semibold hover:from-red-700 hover:to-red-800 transition-all duration-300 flex items-center justify-center transform hover:scale-105 hover:shadow-xl shadow-lg text-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group border-2 border-white/30 text-white px-6 py-3 rounded-xl font-semibold hover:bg-white hover:text-slate-900 transition-all duration-300 flex items-center justify-center backdrop-blur-sm hover:border-white transform hover:scale-105 text-sm"
                >
                ...
                <button className="group bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300 flex items-center justify-center transform hover:scale-105 hover:shadow-xl shadow-lg text-sm">
