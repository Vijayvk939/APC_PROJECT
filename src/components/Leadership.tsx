...
const Leadership = () => {
  ...
  return (
    <section id="leadership" className="pt-4 pb-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full border border-blue-200/50 mb-6">
            ...
            <span className="text-xs font-medium text-blue-700">Meet Our Leaders</span>
          </div>
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 mx-auto mb-6 rounded-full shadow-xl"></div>
        ...
        <div className="mb-20">
          <div className="relative bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/50">
            {/* Background Pattern */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-purple-500/3 to-indigo-500/5"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-0 relative z-10">
              ...
              <div className="p-6 lg:p-8 flex flex-col justify-center lg:min-h-[600px] bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-sm">
                <div className="mb-6">
                  <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full border border-blue-200/50 mb-3">
                    <span className="text-xs font-medium text-blue-700">Founding Pastor</span>
                  </div>
                  
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 leading-tight">
                    {pastorInfo.name}
                  </h3>
                  <p className="text-lg text-blue-600 font-semibold mb-4">{pastorInfo.title}</p>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {pastorInfo.specialties.map((specialty, index) => (
                      <span 
                        key={index}
                        className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg"
                      >
                        {specialty}
                      </span>
                    ))}
          ...
          <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-3xl p-8 text-white overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center items-center">
                <a 
                  href="#contact" 
                  className="bg-white text-blue-600 px-4 py-2 rounded-xl font-semibold flex items-center shadow-lg text-sm"
                >
