  ...
  return (
    <section id="events" className="pt-4 pb-16 md:pb-20 bg-gradient-to-br from-slate-50 via-primary-50 to-secondary-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {regularPrograms.map((program, index) => (
            ...
            >
              ...
              <div className="mb-3 xs:mb-4">
                <h4 className="text-lg xs:text-xl font-bold text-gray-900 mb-1 leading-tight">{program.title}</h4>
                <p className="text-sm xs:text-base font-medium text-primary-600">{program.schedule}</p>
              </div>
              
              <p className="text-gray-600 mb-3 xs:mb-4 leading-relaxed text-sm xs:text-base flex-grow">{program.description}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-6 mb-12 xs:mb-14 sm:mb-16">
          {specialPrayerEvents.map((event, index) => (
            <div 
              key={index}
              className="group bg-white/80 backdrop-blur-sm rounded-lg xs:rounded-xl shadow-xl border border-white/50 overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
            >
              <div className="h-48 xs:h-56 sm:h-64 overflow-hidden">
                <img 
                  src={event.image} 
                  alt={event.title}
              ...
              <div className="p-4 xs:p-5 sm:p-6">
                ...
                <h3 className="text-lg xs:text-xl font-bold text-gray-900 mb-2 leading-tight">{event.title}</h3>
                <div className="flex flex-col xs:flex-row xs:items-center text-gray-600 text-xs xs:text-sm mb-3 gap-1 xs:gap-0">
                ...
                <p className="text-gray-600 leading-relaxed mb-3 xs:mb-4 text-sm xs:text-base">{event.description}</p>
                <button className="flex items-center text-primary-600 font-semibold hover:text-secondary-600 transition-colors text-sm xs:text-base">
                  Learn More <ArrowRight className="w-3 h-3 xs:w-4 xs:h-4 ml-1.5 xs:ml-2" />
                </button>
              </div>
            </div>
          ))}
        ...
        <div className="text-center mb-12 xs:mb-14 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-5 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-lg xs:rounded-xl p-4 xs:p-5 sm:p-6 md:p-7 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden h-32 xs:h-36 sm:h-40 md:h-44 flex items-center">
              ...
              <div className="relative z-10 flex flex-col w-full gap-3">
                <div className="flex-1">
                  <h4 className="text-base xs:text-lg sm:text-xl md:text-xl font-bold text-gray-900 mb-1 xs:mb-2 group-hover:text-primary-700 transition-colors duration-300 leading-tight">Monday - Thursday</h4>
                  <p className="text-gray-600 text-xs xs:text-sm sm:text-base leading-tight">Regular working days</p>
                </div>
                <div className="flex justify-center">
                  <p className="text-primary-600 font-bold text-sm xs:text-base sm:text-lg md:text-lg bg-gradient-to-r from-primary-50 to-secondary-50 px-2 xs:px-3 sm:px-4 md:px-5 py-2 xs:py-2.5 sm:py-3 md:py-3.5 rounded-lg xs:rounded-xl shadow-sm border border-primary-200/50">9:00 AM - 9:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-lg xs:rounded-xl p-4 xs:p-5 sm:p-6 md:p-7 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden h-32 xs:h-36 sm:h-40 md:h-44 flex items-center">
              ...
              <div className="relative z-10 flex flex-col w-full gap-3">
                <div className="flex-1">
                  <h4 className="text-base xs:text-lg sm:text-xl md:text-xl font-bold text-black mb-1 xs:mb-2 group-hover:text-primary-700 transition-colors duration-300 leading-tight">Friday</h4>
                  <p className="text-gray-600 text-xs xs:text-sm sm:text-base leading-tight">Fasting prayer day</p>
                </div>
                <div className="flex justify-center">
                  <p className="text-primary-600 font-bold text-sm xs:text-base sm:text-lg md:text-lg bg-gradient-to-r from-primary-50 to-secondary-50 px-2 xs:px-3 sm:px-4 md:px-5 py-2 xs:py-2.5 sm:py-3 md:py-3.5 rounded-lg xs:rounded-xl shadow-sm border border-primary-200/50">6:30 PM - 9:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-lg xs:rounded-xl p-4 xs:p-5 sm:p-6 md:p-7 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden h-32 xs:h-36 sm:h-40 md:h-44 flex items-center">
              ...
              <div className="relative z-10 flex flex-col w-full gap-3">
                <div className="flex-1">
                  <h4 className="text-base xs:text-lg sm:text-xl md:text-xl font-bold text-gray-900 mb-1 xs:mb-2 group-hover:text-secondary-700 transition-colors duration-300 leading-tight">Saturday</h4>
                  <p className="text-gray-600 text-xs xs:text-sm sm:text-base leading-tight">Weekend service day</p>
                </div>
                <div className="flex justify-center">
                  <p className="text-secondary-600 font-bold text-sm xs:text-base sm:text-lg md:text-lg bg-gradient-to-r from-secondary-50 to-accent-50 px-2 xs:px-3 sm:px-4 md:px-5 py-2 xs:py-2.5 sm:py-3 md:py-3.5 rounded-lg xs:rounded-xl shadow-sm border border-secondary-200/50">9:00 AM - 9:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-lg xs:rounded-xl p-4 xs:p-5 sm:p-6 md:p-7 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden h-32 xs:h-36 sm:h-40 md:h-44 flex items-center">
              ...
              <div className="relative z-10 flex flex-col w-full gap-3">
                <div className="flex-1">
                  <h4 className="text-base xs:text-lg sm:text-xl md:text-xl font-bold text-gray-900 mb-1 xs:mb-2 group-hover:text-accent-700 transition-colors duration-300 leading-tight">Sunday</h4>
                  <p className="text-gray-600 text-xs xs:text-sm sm:text-base leading-tight">Main worship service</p>
                </div>
                <div className="flex justify-center">
                  <p className="text-accent-600 font-bold text-sm xs:text-base sm:text-lg md:text-lg bg-gradient-to-r from-accent-50 to-primary-50 px-2 xs:px-3 sm:px-4 md:px-5 py-2 xs:py-2.5 sm:py-3 md:py-3.5 rounded-lg xs:rounded-xl shadow-sm border border-accent-200/50">8:00 AM - 12:00 PM</p>
                </div>
              </div>
            </div>
          </div>
